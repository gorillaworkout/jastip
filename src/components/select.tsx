  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'after:pointer-events-none after:absolute after:inset-0 after:rounded-[calc(theme(borderRadius.lg)-1px)]  after:ring-inset after:ring-transparent after:has-[[data-focus]]:ring-2 after:has-[[data-focus]]:ring-blue-500',
        // Disabled state
    ...
    >
      <Headless.Select
        ...
        className={clsx([
          // Basic layout
          'relative block w-full appearance-none rounded-lg py-[9px]',
          // Horizontal padding
          multiple
